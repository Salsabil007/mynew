...
simple_expression : term {
		...
		| simple_expression ADDOP term {
				...
				char *t=newTemp();
				if($2->getSymbol()=="+"){ 
					$$->code+="mov al, "+$1->getSymbol()+"\n";
					$$->code+="add al, "+$3->getSymbol()+"\n";
					$$->code+="mov "+string(t)+" ,al\n";
				
				}
				else if($2->getSymbol()=="-"){
					$$->code+="mov al, "+$1->getSymbol()+"\n";
					$$->code+="sub al, "+$3->getSymbol()+"\n";
					$$->code+="mov "+string(t)+" ,al\n";
				}
				$$->setSymbol(t);
				delete $3;
...
unary_expression 	:	ADDOP unary_expression  {
							...
							if($1->getSymbol()=="-")
							{
								...
								char *temp=newTemp();
								$$->code+="mov al, "+$2->getSymbol()+"\n";
								$$->code+="neg al\n";
								$$->code+="mov "+string(temp)+" , al\n";
								$$->setSymbol(temp);
							}
